...
const MessageView = ({ state }) => (react_1.default.createElement("form", null,
    ...
    state.currentView === "message" && react_1.default.createElement("br", null),
    state.currentView === "message" && (react_1.default.createElement(core_1.TextField, { margin: "dense", variant: "outlined", fullWidth: true, label: "From", value: state.messageFrom, disabled: true, InputProps: { style: { color: "#000000" } } })),
    state.currentView === "message" && react_1.default.createElement("br", null),
    state.currentView === "compose" && (react_1.default.createElement(core_1.TextField, { margin: "dense", id: "messageTo", variant: "outlined", fullWidth: true, label: "To", value: state.messageTo, InputProps: { style: { color: "#000000" } }, onChange: state.fieldChangeHandler })),
    state.currentView === "compose" && react_1.default.createElement("br", null),
    react_1.default.createElement(core_1.TextField, { margin: "dense", id: "messageSubject", label: "Subject", variant: "outlined", fullWidth: true, value: state.messageSubject, disabled: state.currentView === "message", InputProps: { style: { color: "#000000" } }, onChange: state.fieldChangeHandler }),
    react_1.default.createElement("br", null),
    react_1.default.createElement(core_1.TextField, { margin: "dense", id: "messageBody", variant: "outlined", fullWidth: true, multiline: true, rows: 12, value: state.messageBody, disabled: state.currentView === "message", InputProps: { style: { color: "#000000" } }, onChange: state.fieldChangeHandler }),
