...
class BaseLayout extends react_1.Component {
    ...
    render() {
        return (react_1.default.createElement("div", { className: "appContainer" },
            react_1.default.createElement(core_1.Dialog, { open: this.state.pleaseWaitVisible, disableBackdropClick: true, disableEscapeKeyDown: true, transitionDuration: 0 },
                react_1.default.createElement(core_1.DialogTitle, { style: { textAlign: "center" } }, "Please Wait"),
                react_1.default.createElement(core_1.DialogContent, null,
                    react_1.default.createElement(core_1.DialogContentText, null, "...Contacting server..."))),
